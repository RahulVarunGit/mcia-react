...
const KiteFest = () => {
  ...
  return(
    ...
    <div className="container">
        ...
        <div>
        <h2 class="center-align"><b>Kite Fest 2023</b></h2>
        </div>

        <div><hr class="hr-line"></hr></div>

        <div>
        <h4 class="center-align c-gray"><span class="c-blue">When:</span> Saturday July 15th, 2023, 11:00 am - 5:00 pm CST</h4>
        </div>
        ...
        <p >&nbsp;&nbsp;</p>
        <div>
        <h4 class="center-align c-gray"><b >For a Better Tomorrow presents Kite Fest, an annual fundraising event benefiting local and global communities. This will be our 10th year in a row since starting in 2014. Kite Fest 2023 will be held on Saturday, July 15, 2023 at Grove Elementary School.</b></h4>
        </div>
        ...
        <p class="center-align"><img src="/images/kiteFest/kiteFest2023.png" alt="" width="100%" className="rounded" /></p>
        <div><hr class="hr-line"></hr></div>
