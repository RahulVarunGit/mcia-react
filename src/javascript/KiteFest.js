...
const KiteFest = () => {
  ...
  return (
    ...
    <div className="container">
      ...
      <p >&nbsp;&nbsp;</p>
      <div>
        <h4 class="center-align c-gray"><b >For a Better Tomorrow presents Kite Fest, an annual fundraising event benefiting local and global communities. This will be our 12th year in a row since starting in 2014. Kite Fest 2024 will be held on Saturday, July 19, 2025 at Grove Elementary School.</b></h4>
      </div>
