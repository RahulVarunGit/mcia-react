...
const YICU = () => {
  ...
  return(
    ...
    <YICUnav ></YICUnav>
    <div>
    <p className="center-align"><img src="/images/YICU/2023/YICU2023.png"alt="YICU 2023" width="200" height="100" className="rounded center-align"></img></p>
    </div>

    <p >&nbsp;&nbsp;</p>
    <div>
    <h3 className="center-align"><b>For A Better Tomorrow (FBT)</b> is proud to accept nominations and applications for 2023 Why I See You (YICU) Service Awards, as part of its mission to recognize and celebrate young adults’ leadership skills and contributions to the broader community.</h3>
    </div>
    ...
    <p >&nbsp;&nbsp;</p>
    <div>
    <h4 className="cFF5833"><b >Note : Last date for nominations is September 15, 2023. Applications are due September 15, 2023.</b></h4>
    </div>
    ...
    <h4 className="cF8F8F8"><u >Required</u></h4>
    <h6 className="cFFFFFF"><i ><a href="https://tinyurl.com/yicuteam"><b><span className="cFFFFFF">Application Form</span></b></a></i></h6>
    ...
    <h6 className="cFFFFFF"><i >Resident of McLean County</i></h6>
    <h4 className="cF8F8F8"><u >Required</u></h4>
    <h6 className="cFFFFFF"><i ><a href="https://tinyurl.com/yicuadvocate"><b><span className="cFFFFFF">Application Form</span></b></a></i></h6>
    </div>
    ...
    <h6 className="cFFFFFF"><i >Resident of McLean County</i></h6>
    <h4 className="cF8F8F8"><u >Required</u></h4>
    <h6 className="cFFFFFF"><i ><a href="https://tinyurl.com/yicumentor"><b><span className="cFFFFFF">Application Form</span></b></a></i></h6>
    </div>
