...
const Committee = () => {
  ...
  return(
    ...
    <h5>
    <img src="/images/board-committees/Contact.png"alt="" width="25" height="25" className="rounded-circle"></img>
    <span > Sambasivarao Gurijala (Chair)</span>
    </h5>
    ...
    <h5>
    <img src="/images/board-committees/Contact.png"alt="" width="25" height="25" className="rounded-circle"></img>
    <span > Carolyn Hansen (Class Facilitator)</span>
    </h5>
